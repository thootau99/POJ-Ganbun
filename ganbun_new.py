...
def input(s):
  ...
  for _t_item in _t:
    ...
    for item in _s:
      ...
      booim = ["i", "iⁿ", "u", "uⁿ", "e", "eⁿ", "o", "o͘", "oⁿ", "a", "aⁿ", "m", "ng", "eng", "ir", "er", "ee"]
      booim_ganbun = ["ㅣ", "ㅣ", "ㅜ", "ㅜ", "ㅔ", "ㅔ", "ㅓ", "ㅗ", "ㅗ", "ㅏ", "ㅏ", "ㅁ", "ㅇ", "ㅒㅇ", "ᅳ", "ᅨ", "ㅒ"]
      hophakbooim = ["ai", "au", "ia", "iu", "io", "io͘", "oa", "oe", "ui", "iau", "oai", "ir", "er", "ee"]
      hophakbooim_ganbun = ["ㅐ", "ᅷ", "ㅑ", "ㅠ", "ㅕ", "ㅛ", "ㅘ", "ㅞ", "ㅟ", "ㅑㄹ", "ㅙ", "ᅳ", "ᅨ", "ㅒ"]
      ...
      if chiap_booim != "":
        ...
        if chiap_hophak == "" and chiap_boe == "" and (chiap_booim == "m" or chiap_booim == "ng") and not ngh:
          ...
          result.append("ㅗ")
          pass
        elif chiap_booim == "e" and (chiap_boe == "p" or chiap_boe == "k"):
          result.append("ㅣ")
          pass
        else:
          result.append(booim_ganbun[booim.index(chiap_booim)])
